...
class GlobalPathPlanner(Node):
    ...
    def __init__(self):
        ...
        # self.get_logger().info(self.ways_info)

        self.ax = [] # x-axis of the waypoints
        self.ay = [] # y-axis of the waypoints

        for node_id, (x, y) in self.way_nodes.items():
            self.ax.append(x)
            self.ay.append(y)
    ...
    def set_waypoints(self):
        ...
        self.get_logger().info('px  : {}'.format(px))
        self.get_logger().info('py  : {}'.format(py))    
