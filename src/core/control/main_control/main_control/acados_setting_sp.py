...
def acados_solver():
    ...
    We_v = W_v * 0.2  # terminal cost에서 속도 error 가중치
    We_lag = W_lag * 0.2  # terminal cost에서 lag error 가중치
    We_con = W_con * 0.2 # terminal cost에서 contour error 가중치
    We_yaw = W_yaw * 2.0  # heading error 가중치 (terminal cost)
