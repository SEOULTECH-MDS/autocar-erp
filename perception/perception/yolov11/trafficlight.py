...
from perception.yolov11.utils.general import check_img_size, non_max_suppression, scale_coords
...
WEIGHTS = os.path.join(package_share, 'yolov11', 'weights', 'tf_best.pt')
