...
class HUD(object):
    def __init__(self, width, height):
        ...
        self.help = HelpText(pygame.font.Font(mono, 32), width, height)
        self.server_fps = 0
        self.frame = 0
    ...
    def render(self, display):
        if self._show_info:
            info_surface = pygame.Surface((500, self.dim[1]))
...
def main():
    ...
    argparser.add_argument(
        '--filter',
        metavar='PATTERN',
        default='vehicle.micro.microlino*',
